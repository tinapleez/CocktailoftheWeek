...
public class MainActivity extends AppCompatActivity implements LoaderManager
    ...
    private void assignViews() {
        mImage = (TextView) findViewById(R.id.image);
        mCocktailName = (TextView) findViewById(R.id.cocktail_name);
        mAuthor = (TextView) findViewById(R.id.author);
        mDate = (TextView) findViewById(R.id.date);
        mSummary = (TextView) findViewById(R.id.summary);
        mlistView = (ListView) findViewById(R.id.list);
        mEmptyView = (TextView) findViewById(R.id.empty_view);
        mSpinningCircle = (ProgressBar) findViewById(R.id.spinning_circle);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize the loader. Pass in the loader ID, and null for the bundle, and this activity
    ...
    public Loader<List<Cocktail>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CocktailLoader(this, COCKTAIL_LOADER_ID);
    }
